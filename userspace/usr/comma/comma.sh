...
handle_comma_konik() {
  sed -i 's/connect.comma.ai/stable.konik.ai\//g' /data/openpilot/selfdrive/ui/qt/widgets/prime.cc
  sed -i 's/comma account/konik account/g' /data/openpilot/selfdrive/ui/qt/widgets/prime.cc

  sed -i 's/connect.comma.ai/stable.konik.ai\//g' /data/openpilot/selfdrive/ui/ui
  sed -i 's/comma account/konik account/g' /data/openpilot/selfdrive/ui/ui
